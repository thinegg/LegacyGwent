...
namespace Cynthia.Card
{
    public static class GwentMap
    {
        ...
        public static IDictionary<Categorie, string> CategorieInfoMap { get; } = new Dictionary<Categorie, string>()
        {
            ...
            { Categorie.WildHunt, "狂猎" },
            { Categorie.Tactic, "谋略" },
            { Categorie.Beast, "野兽" },
            { Categorie.Leader, "领袖牌" },
            { Categorie.Mage, "法师" },
            { Categorie.Boss, "首领" },
            { Categorie.Vampire, "吸血鬼" },
            { Categorie.Cintra, "辛特拉" },
            { Categorie.Insectoid, "类虫生物" },
            { Categorie.Stray, "流亡军" },
            { Categorie.Construct, "构造体" },
            { Categorie.Spell, "法术" },
            { Categorie.Redania, "瑞达尼亚" },
            { Categorie.SiegeSupport, "攻城支援" },
            { Categorie.ClanDrummond, "德拉蒙家族" },
            { Categorie.Specter, "鬼灵" },
            { Categorie.Cursed, "诅咒生物" },
            { Categorie.Soldier, "士兵" },
            { Categorie.Kaedwen, "科德温" },
            { Categorie.Vodyanoi, "水生" },
            { Categorie.ClanTuirseach, "图尔赛克家族" },
            { Categorie.ClanTordarroch, "托达洛克家族" },
            { Categorie.ClanDimun, "迪门家族" },
            { Categorie.Witcher, "猎魔人" },
            { Categorie.Cultist, "呓语" },
            { Categorie.Alchemy, "炼金" },
            { Categorie.Reckless, "鲁莽" },
            { Categorie.ClanHeymaey, "海玫家族" },
            { Categorie.Blitz, "闪击" },
            { Categorie.Dryad, "树精" },
            { Categorie.Special, "特殊" },
            { Categorie.Elf, "精灵" },
            { Categorie.Lyria, "莱里亚" },
            { Categorie.Necrophage, "食腐生物" },
            { Categorie.Machine, "机械" },
            { Categorie.Aedirn, "亚甸" },
            { Categorie.Support, "辅助" },
            { Categorie.ClanAnCraite, "奎特家族" },
            { Categorie.Dwarf, "矮人" },
            { Categorie.Draconid, "龙兽" },
            { Categorie.SiegeEngine, "攻城器械" },
            { Categorie.Temeria, "泰莫利亚" },
            { Categorie.Officer, "军官" },
            { Categorie.Weather, "天气" },
            { Categorie.Organic, "有机" },
            { Categorie.Item, "道具" },
            { Categorie.Hazard, "灾厄" },
            { Categorie.Boon, "恩泽" },
            { Categorie.Ambush, "伏击" },
            { Categorie.Doomed, "佚亡" },
            { Categorie.Bear, "巨熊" },
            { Categorie.Ogroid, "食人魔" },
            { Categorie.BlueStripes, "蓝衣铁卫" },
            { Categorie.Breedable, "繁育" },
            { Categorie.Devourer, "吞食者" },
            { Categorie.Dragon, "巨龙" },
            { Categorie.Harpy, "鹰身女妖" },
            { Categorie.Medic, "医生" },
            { Categorie.Stubborn, "坚守" },
            { Categorie.Permadeath, "永逝" },
            { Categorie.Peasant, "农民" },
            { Categorie.Potion, "药水" },
            { Categorie.Relict, "残物" },
            { Categorie.Regressing, "回溯" },
            { Categorie.Shapeshifter, "变身" },
            { Categorie.Token, "退场" },
            { Categorie.Agent, "密探" },
